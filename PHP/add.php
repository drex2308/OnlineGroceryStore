...
<div class="login-box">
  <span><?php echo $error; ?><br></br></span>
    ...
    <h1> Add New Stock </h1>
        ...
        <p>Category</p>
        <input type="text" placeholder="Category" id="type" name="type"><br/><br/>
        <p>Price</p>
        <input type="number" min="0" placeholder="Price" id="price" name="price">
        <p>Offer</p>
        <input type="number" min="0" placeholder="Offer" id="offer" name="offer"><br/><br/>
        <p>New Stock value</p>
        <input type="number" min="0" placeholder="Availability" id="nos" name="nos"><br/><br/>
        <p>Popularity</p>
        <input type="number" max="1" placeholder="Popularity" id="pop" name="pop">
        <p>Image</p>
